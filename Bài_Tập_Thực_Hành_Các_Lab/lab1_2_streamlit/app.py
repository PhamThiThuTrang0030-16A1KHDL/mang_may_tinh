...
if st.session_state.led_on:
    image_file = "C:\study\ktra_mang_may_tinh\lab1_2_streamlit\images\led_on_white_120.png"
else:
    image_file = "C:\study\ktra_mang_may_tinh\lab1_2_streamlit\images\led_off_white_120.png"
